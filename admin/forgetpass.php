...
<div class="title">
	...
	<i class="fa fa-home"></i> <a href="admin.php">Dashboard</a> / <i class="fa fa-book"></i> Rekap Lupa Password
	</div>
...
<div class="table-responsive">
 <table id="example" class="table table-striped table-bordered table-hover" cellspacing="0">
				<thead>
				<tr><th colspan="15"><center>REKAP LUPA PASSWORD</center></th></tr>
				<tr>
				<th>No</th>
				<th>Email</th>
				<th>Type User</th>
				...
				$query=mysqli_query($koneksi,"select * from forget_pass");
				$no=1;
				...
				?>
					...
					<tr>
						...
						<td><?php echo $var['type_user'];?></td>
						<td><?php echo $var['waktu'];?></td>
						<td><?php echo "<center><a class='fa fa-trash' title='Hapus' href='delete.php?no=".$var['no']."'></a></center>"; ?></td>
