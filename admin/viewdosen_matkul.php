...
<div class="title">
	...
	<i class="fa fa-home"></i> <a href="admin.php">Dashboard</a> / <i class="fa fa-folder-open-o"></i> Rekap Jadwal
	</div>
...
<table id="example" class="table table-striped table-bordered table-hover" cellspacing="0">
				...
				include "../proses/koneksi.php";
				$query=mysqli_query($koneksi,"select * from dosen_matkul where id_dosen='$id_dosen'");
				$var=mysqli_fetch_array($query); {
				echo"
				<tr><th colspan='15'><a href='cetak/printpdfmatkuldsn.php?&id_dosen=$var[id_dosen]'><input class='btn btn-success btn-lg' type='button' value='Cetak Pdf'></a> <a href='cetak/printexlmatkuldsn.php?&id_dosen=$var[id_dosen]''><input class='btn btn-success btn-lg' type='button' value='Cetak Excel'></a><center>REKAP JADWAL</center></th></tr>
				";
				}
				?>
				<tr>
				...
				$nama_kelas=mysqli_fetch_array(mysqli_query($koneksi, "SELECT kelas FROM kelas WHERE kode_kelas='$var[kode_kelas]'"));
				?>
					...
					<tr>
						...
						<td><?php echo $nama_kelas['kelas'];?></td>
						...
						<td><?php echo "<center><a class='fa fa-trash' title='Hapus' href='delete_matkul_dosen.php?no=".$var['no']."'></a></center>"; ?></td>
