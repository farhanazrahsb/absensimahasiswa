...
<div class="title">
	...
	<i class="fa fa-home"></i> <a href="admin.php">Dashboard</a> / <i class="fa fa-address-book"></i> Input Kelas
	</div>

	<div class="content">
     <form role="form" action="cekinputkelas.php" method="post">
     <div class="form-group">
     <div class="col-md-4">
     <h3>FORM INPUT KELAS</h3><br>
  	 <label>Kode Jurusan</label><br>
     <select name="kode_jurusan" class="selectpicker form-control" data-live-search="true">
     ...
     <input class="form-control" name="kode_kelas" placeholder="Kode Kelas">
     <br>
     <label>Kelas</label>
