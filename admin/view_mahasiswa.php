...
<a class="btn" onclick=self.history.back()> <span class="fa fa-arrow-left" title="Kembali"></span></a>
 <table id="example" class="table table-striped table-bordered table-hover" cellspacing="0">
				<thead>
				<tr><th colspan="15"><a href="cetak/printpdallfmhs.php"> <input class="btn btn-success btn-lg" type="button" value="Cetak Pdf"></a> <a href="cetak/printexlallmhs.php"><input class="btn btn-success btn-lg" type="button" value="Cetak Excel"></a><center>REKAP MAHASISWA</center></th></tr>
				<tr>
				<th>No</th>
				<th>NPM</th>
				<th>Nama</th>
				...
				$query=mysqli_query($koneksi,"select * from input_mhs");
				$no=1;
