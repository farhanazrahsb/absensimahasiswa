...
<div class="title">
	...
	<i class="fa fa-home"></i> <a href="admin.php">Dashboard</a> / <i class="fa fa-address-book"></i> Input Dosen
	</div>

	<div class="content">
	<form role="form" action="cekinputdosen.php" method="post">
     <div class="form-group">
     <div class="col-md-4">
     <h3>FORM INPUT DOSEN</h3><br>
  	 <label>ID Dosen</label><br>
     <input class="form-control" name="id_dosen" placeholder="ID Dosen">
     <br>
     <label>Nama</label>
