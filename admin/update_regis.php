...
<div class="title">
  ...
  <i class="fa fa-home"></i> <a href="admin.php">Dashboard</a> / <i class="fa fa-address-book"></i> Edit Data Admin
  </div>
<div class="content">
<h2>Edit Data Admin</h2>
  <form action="../proses/updateregis_proses.php" method="POST">
     <div class="form-group">
     <div class="col-md-4">
     <label>ID Admin</label>
     <input class="form-control" name="id_admin" placeholder="ID Admin" value="<?php echo $var['id_admin']; ?>" readonly>
     <br>
     <label>Nama</label>
