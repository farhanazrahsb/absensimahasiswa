...
<div class="title">
	...
	<i class="fa fa-home"></i> <a href="admin.php">Dashboard</a> / <i class="fa fa-address-book"></i> Input Matkul
	</div>
	...
	// membuat query max
	  $carikode = mysqli_query($koneksi, "select max(kode_matkul) from matkul") or die (mysql_error());
	  // menjadikannya array
	...
	echo'
	<div class="content">
     <form role="form" action="cekinputmatkul.php" method="post">
     <div class="form-group">
     <div class="col-md-4">
     <h3>FORM INPUT MATA KULIAH</h3><br>
  	 <label>Kode Mata Kuliah</label><br>
     <input class="form-control" name="kode_matkul" placeholder="Kode Matkul" value="'.$kode_otomatis.'" readonly>
     <br>
     <label>Mata Kuliah</label>
     <input class="form-control" name="matkul" placeholder="Mata Kuliah">
     <br>
