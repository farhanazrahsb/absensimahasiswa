...
<div class="title">
	...
	<i class="fa fa-home"></i> <a href="admin.php">Dashboard</a> / <i class="fa fa-folder-open-o"></i> Rekap Admin
	</div>
...
<div class="table-responsive">
 <table id="example" class="table table-striped table-bordered table-hover" cellspacing="0">
				<thead>
				<tr><th colspan="8"><a href="cetak/printpdfadm.php"><input class="btn btn-success btn-lg" type="button" value="Cetak Pdf"></a> <a href="cetak/printexladm.php"><input class="btn btn-success btn-lg" type="button" value="Cetak Excel"></a><center>REKAP ADMIN</center></th></tr>
				<tr>
				<th>No</th>
				<th>ID Admin</th>
				<th>Nama</th>
				...
				?>
					...
					<tr>
						...
						<td><?php echo "<center><a class='fa fa-pencil-square-o' title='Edit' href='update_regis.php?no=".$var['no']."'></a> | <a class='fa fa-trash' title='Hapus' href='delete_regis.php?no=".$var['no']."'></a></center>"; ?></td>
