...
<div class="title">
	...
	<i class="fa fa-home"></i> <a href="admin.php">Dashboard</a> / <i class="fa fa-folder-open-o"></i> Rekap Dosen
	</div>
			...
			<table id="example" class="table table-striped table-bordered table-hover" cellspacing="0">
				<thead>
				<tr><th colspan="15"><a href="cetak/printpdfdsn.php"><input class="btn btn-success btn-lg" type="button" value="Cetak Pdf"></a> <a href="cetak/printexldsn.php"><input class="btn btn-success btn-lg" type="button" value="Cetak Excel"></a><center>REKAP DOSEN</center></th></tr>
				<tr>
				<th>No</th>
				<th>ID Dosen</th>
				<th>Nama Dosen</th>
				...
				$query=mysqli_query($koneksi,"select * from input_dosen");
				$no=1;
				...
				?>
					...
					<tr>
						...
						<td><a href="viewdosen_matkul.php?&id_dosen=<?php echo $var['id_dosen']; ?>" type="button" class="btn btn-info btn-md" title="Detail Dosen"><?php echo $var['nama'];?></a></td>
						<td><?php echo $var['email'];?></td>
						<td><?php echo "<center><a class='fa fa-pencil-square-o' title='Edit' href='update_dosen.php?no=".$var['no']."'></a> | <a class='fa fa-trash' title='Hapus' href='delete_dosen.php?no=".$var['no']."'></a></center>"; ?></td>
