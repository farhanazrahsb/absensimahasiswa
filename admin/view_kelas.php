...
<a href="view_kelas.php"><button class="btn btn-info btn-lg" type="submit">Kelas</button></a></center><br>
 <table id="example" class="table table-striped table-bordered table-hover" cellspacing="0">
				<thead>
				<tr><th colspan="15"><center>REKAP KELAS</center></th></tr>
				<tr>
				<th>No</th>
				<th>Kode Jurusan</th>
				<th>Kode Kelas</th>
				...
				?>
					...
					<tr>
						...
						<td><?php echo $var['kode_kelas'];?></td>
						<td><?php echo $var['kelas'];?></td>
						<td><?php echo "<center><a class='fa fa-trash' title='Hapus' href='delete_kelas.php?kode_kelas=".$var['kode_kelas']."'></a></center>"; ?></td>
