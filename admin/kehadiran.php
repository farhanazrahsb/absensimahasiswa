...
<div class="table-responsive">
 <table id="example" class="table table-striped table-bordered table-hover" cellspacing="0">
				<thead>
				<tr><th colspan="18"><a href="cetak/printpdfadm.php"><input class="btn btn-success btn-lg" type="button" value="Cetak Pdf"></a> <a href="cetak/printexladm.php"><input class="btn btn-success btn-lg" type="button" value="Cetak Excel"></a><center>REKAP KEHADIRAN</center></th></tr>
				<tr>
				<th>No</th>
				<th>Nama</th>
				<th>Pertemuan 1</th>
