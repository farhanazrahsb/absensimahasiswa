...
<a class="btn" onclick=self.history.back()> <span class="fa fa-arrow-left" title="Kembali"></span></a>
 <table id="example" class="table table-striped table-bordered table-hover" cellspacing="0">
				<thead>
				<tr><th colspan="15"><a href="cetak/printpdfabsen.php"><input class="btn btn-success btn-lg" type="button" value="Cetak Pdf"></a> <a href="cetak/printexlabsen.php"><input class="btn btn-success btn-lg" type="button" value="Cetak Excel"></a><center>REKAP ABSENSI</center></th></tr>
				<tr>
				<th>No</th>
				<th>Pertemuan</th>
				<th>NPM</th>
