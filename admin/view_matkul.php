...
<a href="view_kelas.php"><button class="btn btn-info btn-lg" type="submit">Kelas</button></a></center><br>
 <table id="example" class="table table-striped table-bordered table-hover" cellspacing="0">
				<thead>
				<tr><th colspan="15"><center>REKAP MATKUL</center></th></tr>
				<tr>
				<th>No</th>
				<th>Kode Matkul</th>
				<th>Matkul</th>
				...
				?>
					...
					<tr>
						<td><?php echo $no ?></td>
						<td><?php echo $var['kode_matkul'];?></td>
						<td><?php echo $var['matkul'];?></td>
						<td><?php echo "<center><a class='fa fa-trash' title='Hapus' href='delete_matkul.php?kode_matkul=".$var['kode_matkul']."'></a></center>"; ?></td>
