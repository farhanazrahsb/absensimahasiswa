...
if (isset($_POST['username'])){
    ...
    //Checking is user existing in the database or not
        $query = "SELECT * FROM input_mhs WHERE username='$username'
...
<!-- //For-Mobile-Apps -->
<!-- Style --> <link rel="stylesheet" href="../admin/css/style2.css" type="text/css" media="all" />
</head>
<body>


<div class="container">
<h1>FORM LOGIN MAHASISWA</h1>
     <div class="contact-form">
	 <div class="profile-pic">
	 <a href="../index.php"><img src="../assets/images/ug.png"/></a>
	 </div>	 
	 <div class="signin">
